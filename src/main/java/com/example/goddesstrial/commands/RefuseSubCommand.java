...
public class RefuseSubCommand extends AbstractPlayerCommand {

    private final TrialManager trialManager;

    public RefuseSubCommand(TrialManager trialManager) {
        super("refuse", "Refuse the Trial of the Goddess");
    ...
    protected void execute(
        ...
        TrialManager.TrialResult result = trialManager.refuseTrial(playerName);
