...
import com.example.goddesstrial.ui.GoddessTrialDashboardUI;

import javax.annotation.Nonnull;

/**
 * /trial ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening GoddessTrial Dashboard..."));
        ...
        try {
            ...
            GoddessTrialDashboardUI dashboardPage = new GoddessTrialDashboardUI(playerRef);
