...
/**
 * GoddessTrial Dashboard UI
 *
 * A simple interactive dashboard page showing plugin information
 * with refresh and close buttons.
 */
public class GoddessTrialDashboardUI extends InteractiveCustomUIPage<GoddessTrialDashboardUI.UIEventData> {

    // Path relative to Common/UI/Custom/
    public static final String LAYOUT = "goddesstrial/Dashboard.ui";

    private final PlayerRef playerRef;
    private int refreshCount = 0;

    public GoddessTrialDashboardUI(@Nonnull PlayerRef playerRef) {
